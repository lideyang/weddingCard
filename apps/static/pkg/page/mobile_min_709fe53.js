define("page/mobile", function (n, e, t) {
    (function () {
        ...
        p = n("common"), s = n("loading"), m = n("pageManagement"), n("zepto/touch"), c = n("bounceFix"), h = n("slideProgress"), n("animation/animation.async.css"), a = null, r = null, o = null, u = null, i = null, e = null, l = null, b = function () {
            var n, t, p, f;
            ...
            return p = d(pageData.link), r = g[pageData.user_from], m = pageData.musiccfg || {}, s = f[m.type], c = parseInt(pageData.level || 0), isNaN(c) && (c = 0), c >= 3 ? pageData.company ? e.find(".free-show").html("<a class='link' rel='nofollow' href='" + (p || "javascript:void()") + "'>" + pageData.company + "</a>") : e.find(".free-show").hide() : c >= 2 ? (a = pageData.company ? "<a class='link' rel='nofollow' href='" + (p || "javascript:void()") + "'>" + pageData.company + "</a> | <a class='link' rel='nofollow' href='/mobile?mobile=1'>兔展技术支持</a>" : "<a class='link' rel='nofollow' href='/mobile?mobile=1'>兔展技术支持</a>", e.find(".free-show").html(a)) : null != r ? (a = "<a class='link' rel='nofollow' href='" + r.link + "'>" + r.company + "</a> | <a class='link' rel='nofollow' href='/mobile?mobile=1'>兔展技术支持</a>", e.find(".free-show").html(a)) : null != s ? (w = s.shares, p = m.link || s.link, i = p, o = s.company, null != w && (u = Math.floor(Math.random() * w.length), h = null != (v = w[u]) ? v : w[0], p = m.link || h.desc, i = h.desc, o = h.value), a = "<a class='link' data-href='" + i + "' rel='nofollow' href='" + p + "'>" + o + "</a> | <a class='link' rel='nofollow' href='/mobile?mobile=1'>兔展技术支持</a>", e.find(".free-show").html(a)) : (u = Math.floor(Math.random() * (k.length - .002)), (l = k[u]) ? (t = e.find(".j-free-show-span"), n = e.find(".j-free-show-link"), t.length && l.value && t.text(l.value), n.length && l.desc ? n.attr("href", l.desc) : void 0) : void 0)
        }, w = function () {
            var n;
    ...
    (function () {
        ...
        t = n("zepto"), n("zepto/fx"), n("zepto/fx.method"), s = n("animation"), c = null, r = null, o = null, a = null, d = null, u = null, i = null, l = null, f = null, g = 0, h = null, w = window.devicePixelRatio, m = function (n) {
            ...
            return null == n && (n = {}), c = t("#loading-wrapper"), r = c.find(".loading"), o = c.find(".background"), a = c.find(".percent"), d = c.find(".progress"), u = c.find(".logo"), i = c.find(".loading-bottom"), l = c.find(".loading-img"), f = c.find(".unit"), o.attr({
                width: r.width() * w,
                height: r.height() * w
            }), l.hide(), a.show(), f.show(), i.text(null != (e = n.company) ? e : "欢迎使用兔展创作"), null != n.src && ("" !== n.src ? u.css("backgroundImage", "url(" + n.src + ")") : u.removeClass("rabbitpre")), b(.1)
        }, p = function () {
