define("page/mobile/mobile.async", function (a) {
    (function () {
        var t, e, i, n, o, d, p, r;
        a("page/mobile/mobile.async.less"), a("effect"), e = a("common"), n = a("music"), d = a("share"), i = a("db"), a("fingerprintDialog"), a("shareMask"), a("blessingList"), t = null, o = a("reportAbuse"), p = a("stat"), r = function (a) {
            var t, e, i;
            t = [];
            for (e in a)i = a[e], i && t.push("" + e + "=" + (i || ""));
            return t.join("&")
        }, function () {
            var a, u, l, c, f, s, g, w, b, h, D, m, v, y, S, k, K, V, j, q, M;
            for (p.init(), a = $(".link"), a.one("tap", function () {
                ...
                url: "/app/viewcount",
                type: "get",
                data: {appid: pageData.id},
                success: function () {
                }
            }), i.getMusic = i.registerMethod({type: "get"}), null != pageData.id && i.reportViewCount(), w = null != (V = pageData.musiccfg) ? V : {}, w.mid ? i.getMusic({
            ...
            }) : n.init(), u = window.location, y = u.search, y = y ? y.substring(1) : "", y = y.split("&"), h = {}, k = 0, K = y.length; K > k; k++)g = y[k], g && (g = g.split("="), g[0] && (h[g[0]] = decodeURIComponent(g[1])));
            return window._hmt = window._hmt || [], e.loadScript(null != ("undefined" != typeof pageData && null !== pageData ? pageData.ad : void 0) ? "//hm.baidu.com/hm.js?5f2111f90d14723adeeb19dd2bbcce8d" : "//hm.baidu.com/hm.js?9ad3eedcbfcad678357018dda8c8c602"), D = [], l = pageData.cnl || h.cnl, l && D.push("cnl=" + l), c = h.debug, c && D.push("debug=" + c), m = D.join("&"), m && (m = "?" + m), e.loadScript("http://webapi.amap.com/maps?v=1.3&key=e2cad13fd9a89339f9a07c7758c42623"), f = function () {
            }, /^mk/.test(pageData.app_pfid) ? (b = function () {
                var a, t, i;
                return null != ("undefined" != typeof pageData && null !== pageData ? pageData.ad : void 0) && (a = pageData.ad, null != (t = window.dataSDK) && "function" == typeof t.pushView && t.pushView(a.pfid, a.id)), null != (i = window.fiboSDK) ? i.init({
                    pfid: pageData.app_pfid,
                    appid: pageData.id,
                    actid: e.bom.query("actid"),
                    stepid: e.bom.query("stepid")
                }) : void 0
            }, e.loadScript("https://res.fibodata.com/data/fibosdk.min.js", b, f, {id: "newFiboDataSDK"})) : (s = {
                pfid: pageData.app_pfid || "55306108c51369f023cf59b2",
                appid: pageData.id,
                blext: !1
            }, pageData.organizationid && (s.pfid = pageData.organizationid, s.blext = !0), b = function () {
                var a, t, e;
                return null != ("undefined" != typeof pageData && null !== pageData ? pageData.ad : void 0) && (a = pageData.ad, null != (t = window.dataSDK) && "function" == typeof t.pushView && t.pushView(a.pfid, a.id)), window.adsenable === !0 && null != (e = window.dataSDK) && "function" == typeof e.pushView ? e.pushView("UqAFqbzv", "13c35185-af4b-4888-9168-b32e9f007bca") : void 0
            }, e.loadScript("//sdk.fibodata.com/data/datasdk.min.js?" + r(s), b, f, {id: "fiboDataSDK"})), S = "default", pageData.level > "2" && (S = "vip"), "3" === pageData.state && (S = "safe"), d.init({
                debug: "true" === h.debug,
                title: (pageData.name || "").replace("{{count}}", pageData.viewcount),
                link: null != (j = pageData.shareUrl) ? j : location.origin + location.pathname + m + "#from=share",
                imgUrl: null != (q = pageData.imgPath) ? q : "http://file.rabbitpre.com/default.png",
                desc: pageData.desc,
                userLevel: S,
                appState: pageData.state,
                cnl: null != (M = e.bom.query("cnl")) ? M : null,
                onShare: function (a) {
                    var t, n;
                    ...
                    }), window.fiboSDK ? void window.fiboSDK.share(a) : null != (n = window.dataSDK) && "function" == typeof n.share ? n.share(a) : void 0
                },
                onCancel: function () {
                }
            }), t = $("#app-bottom"), t.on("tap", ".link-report-abuse", function () {
                return o(function () {
                ...
                return t = e.code, "PREV" === t ? void("function" == typeof window.prevPage && window.prevPage()) : void("NEXT" === t && "function" == typeof window.nextPage && window.nextPage())
    ...
    (function () {
        ...
        p = a("common"), t = a("zepto"), s = null, i = null, n = t("#wrapper"), u = t(window), l = function () {
            ...
            if (pageData.music && (a = "", 0 !== pageData.music_is_auto && (a = "autoplay = 'autoplay'"), s = t("<div id='music' class='music stopped'>		<audio id='music-audio'  class='audio' src='" + pageData.musicPath + "' loop " + a + " preload='auto' >		</audio>		<div class='control'><div class='control-after'></div></div>	</div>"), s.appendTo(n), i = s.find("audio"), i[0].load(), 0 !== pageData.music_is_auto && (i.on("canplay", function () {
                ...
                }), 0 !== pageData.music_is_auto))return u.on("touchstart", o = function () {
        ...
        }, o.exports = {init: l, stopSilently: d, playSilently: e, stop: c}
    }).call(this)
});
;define("share", function (n, e, i) {
    (function () {
        var e, o, t, r, a, l, c, u;
        e = n("zepto"), t = n("common"), o = n("async"), r = n("db"), a = n("stat"), l = function (n) {
            return r.fetchWxShare = r.registerMethod({
                url: "/common/wxshare",
                type: "get"
            }), -1 !== navigator.userAgent.toLowerCase().indexOf("micromessenger") ? c(n) : void 0
        }, c = function (n) {
            return o.parallel([function (e) {
                ...
                var o, t, r;
                if (!i.errorCode)return o = null != (r = n.debug) ? r : !1, t = {
                    debug: o,
                ...
                }, n.link = ("undefined" != typeof pageData && null !== pageData ? pageData.sharelimit : void 0) || i.shareUrl || n.link, delete i.shareUrl, window.wx.config(e.extend({}, t, i)), window.wx.ready(function () {
                    var i, o;
                    return i = e("#music-audio"), null != i[0] && "autoplay" === i.attr("autoplay") && null != (o = i[0]) && o.play(), u(n)
                }), window.wx.error(function (n) {
                    return n.params = t, a.sendComponent("ERROR", "WEXINCONFIG", "" + JSON.stringify(n)), o === !0 ? alert(JSON.stringify(n)) : void 0
                })
            })
        }, u = function (n) {
            return window.dataSDK && window.dataSDK.dealUrl ? n.link = window.dataSDK.dealUrl(n.link) : window.fiboSDK && window.fiboSDK.dealUrl && (n.link = window.fiboSDK.dealUrl(n.link)), n.desc || (n.desc = n.title), window.wx.onMenuShareTimeline({
                title: n.title,
                link: n.link,
                imgUrl: n.imgUrl,
                success: function () {
...
;define("fingerprintDialog", function (n, t, o) {
    (function () {
        var t, e, r, c = {}.hasOwnProperty, i = function (n, t) {
            function o() {
                this.constructor = n
            }
...
;define("shareMask", function (n, e, s) {
    (function () {
        ...
        e = n("zepto"), n("shareMask/shareMask.async.less"), r = !1, o = null, a = function () {
            ...
            return r || a(), o.hide()
        }, s.exports = {show: i, hide: t}
    }).call(this)
});
;define("blessingList", function (n, t, e) {
    (function () {
        var t, o, r, i, a, l, s, u, c, d, p, m, g, f, h, v, b, C, w, D, P, y, k, L, R, E, I, M, N, O, T, x, z, A, G, H,
            S, Y, j;
        t = n("zepto"), m = n("common"), w = n("blessingList/blessingList.tpl"), C = n("blessingList/blessingItem.tpl"), g = n("db"), L = !1, a = null, i = null, c = null, l = null, d = null, r = null, s = null, u = null, o = null, p = null, f = 140, h = 15, D = 0, O = 20, N = 500, T = 500, v = {
            ...
            return i.on("input", function () {
                ...
                var a, u;
                return r.preventDefault(), o || e || !j(!0) ? void 0 : (o = !0, u = "", (pageData.level || 0) >= 2 && (u = pageData.logoPath ? "background: url('" + pageData.logoPath + "') no-repeat center center;background-size: contain;" : "display: none;"), a = t(n("pageManagement/loading.tpl")({style: u})), a.appendTo(l), i.add(c).blur(), M.addComment && M.addComment({content: m.str.trim(i.val())}), g.postComment({
                    data: {
                        appid: pageData.id,
            ...
            return R ? void 0 : (R = !0, g.getComments({
                data: {page: D + 1, pagesize: O}, success: function (n) {
                    return s.append(C(n, {C: m})), D += 1, 0 === n.data.length && 1 === D ? void S(v.EMPTY) : S(O !== n.data.items.length ? v.END : v.LOADING)
                }, error: function () {
                    return S(v.ERROR)
                }, complete: function () {
                    return R = !1, G()
        ...
        }, e.exports = {init: k, show: z}
    }).call(this)
});
;define("reportAbuse", function (t, e, r) {
    (function () {
        var e, o, n, p, s, i, a, u = {}.hasOwnProperty, c = function (t, e) {
            function r() {
                this.constructor = t
            }
        ...
        e = t("zepto"), p = t("dialog"), o = t("dialog/alert"), a = t("reportAbuse/postAd"), i = t("reportAbuse/reportAbuse.tpl"), t("reportAbuse/reportAbuse.async.less"), n = t("db"), n.reportAbuse = n.registerMethod({
            url: "/app/report",
            type: "post"
        }), s = function (t) {
            function r(t) {
                ...
                return this === window ? new r(t) : (p = e.extend({}, {
                    ...
                    onConfirm: function () {
                        var e;
                        return e = s.$dom.find("input:checked").parent(), e.hasClass("illegal-poster") ? (a.uploadFile(), o({title: "提交成功"})) : (n.reportAbuse({
                            data: {
                                appid: pageData.id,
                                reason: e.text()
                            }
                        }), o({title: "提交成功"})), "function" == typeof t ? t() : void 0
                    }
...
;define("dialog/alert", function (t, o, n) {
    (function () {
        var o, r, e, i = {}.hasOwnProperty, c = function (t, o) {
            function n() {
                this.constructor = t
            }
        ...
        o = t("zepto"), e = t("dialog"), r = function (t) {
            function n(t) {
                return this === window ? new n(t) : (t = o.extend({}, t, {confirm: "确认"}), void n.__super__.constructor.call(this, t))
            }
...
;define("reportAbuse/postAd", function (e, t, n) {
    (function () {
        var t, r, o, i, a, u, p, s, c;
        t = e("zepto"), o = e("db"), r = e("dialog/alert"), o.getSignature = o.registerMethod({url: "/upload/report/params"}), o.postFile = o.registerMethod({
            type: "POST",
            dataType: "json",
            cache: !1,
            processData: !1,
            ...
            url: "/app/report",
            type: "post"
        }), i = t("html").html(), -1 !== location.hash.indexOf("REPORTAD") && setTimeout(function () {
            return c(function (e) {
                return r({title: "举报广告成功：" + e.get("key")})
            })
        }, 5e3), p = function () {
            var e, n, r, o, u;
            return r = i, o = a(r), e = a(), u = o.innerHTML.length, n = e.innerHTML.length, n > u ? i = t("html").html() : void 0
        }, a = function (e) {
            var n, r;
            return n = document.createElement("html"), n.innerHTML = e || t("html").html(), r = t(n), r.find(".wrapper").remove(), r.find("head").remove(), r.find(".dialog-outer").remove(), n
        }, u = function (e, t) {
            var n;
            return n = [], n.push({name: "xxx.html"}), o.getSignature({
                data: {
                    serverType: "A",
                    type: "REPORT",
                    count: 1,
            ...
            var r, a, u, p, s, c;
            a = i, r = new FormData, r.append("OSSAccessKeyId", e.accessKey), r.append("policy", e.policy), r.append("signature", e.token), r.append("key", "" + e.key), s = null != (c = e.xparams) ? c : {};
            for (u in s)p = s[u], r.append("x-oss-meta-" + u, p);
            return r.append("file", new File(["<html>" + a + "</html>"], "" + e.key + ".html", {type: "text/html"})), o.postFile({
        ...
        }, n.exports = {uploadFile: c}
    }).call(this)
});
;define("reportAbuse/reportAbuse.tpl", function (l, e, a) {
    a.exports = function (l) {
        l = l || {};
        var e = [];
        return e.push('<ul class="reasons"> <li class="reason"> <label class="illegal-poster"><input type="radio" name="reason" checked/>电信广告</label> </li> <li class="reason"> <label><input type="radio" name="reason"/>欺诈、谣言</label> </li> <li class="reason"> <label><input type="radio" name="reason"/>诱导分享、恶意营销、隐私收集</label> </li> <li class="reason"> <label><input type="radio" name="reason"/>色情、赌博、毒品</label> </li> <li class="reason"> <label><input type="radio" name="reason"/>抄袭、侵权</label> </li> <li class="reason"> <label><input type="radio" name="reason"/>其它原因</label> </li></ul>'), e.join("")
    }
});
